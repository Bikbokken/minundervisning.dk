...
function CheckNullValues(values) {
...
function CheckFormular(key, values) {
    console.log(IsNotNull(values.B))
    console.log(IsNotNull(values.C))
    console.log(IsNotNull(values.A))
    switch (key) {
        ...
        switch(key) {
            ...
            case "a":
                ...
                if (IsNotNull(values.b) && IsNotNull(values.B)) {
                    ...
                    const value = (values.b / Math.tan(values.B)).toFixed(2);
            ...
            case "b":
                ...
                if (IsNotNull(values.a) && IsNotNull(values.A)) {
                    ...
                    const bValue = (values.a / Math.tan(values.A)).toFixed(2);
