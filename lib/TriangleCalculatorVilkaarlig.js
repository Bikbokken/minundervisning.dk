import { IsNotNull, radToDeg } from './common.js';
    ...
    switch (key) {
        ...
        case "A":
            ...
            if (IsNotNull(values.a) && IsNotNull(values.C) && IsNotNull(values.c)) {
                ...
                const deg = radToDeg(Math.asin((values.a * Math.sin(toRadians(values.C))) / values.c));
            ...
            if (IsNotNull(values.a) && IsNotNull(values.B) && IsNotNull(values.b)) {
                ...
                const deg = radToDeg(Math.asin((values.a * Math.sin(toRadians(values.B))) / values.b));
            ...
            if (IsNotNull(values.b) && IsNotNull(values.c) && IsNotNull(values.a)) {
                ...
                const deg = radToDeg(Math.acos((Math.pow(values.b, 2) + Math.pow(values.c, 2) - Math.pow(values.a, 2)) / (2 * values.b * values.c)));
        ...
        case "B":
            ...
            if (IsNotNull(values.b) && IsNotNull(values.C) && IsNotNull(values.c)) {
                ...
                const deg = radToDeg(Math.asin((values.b * Math.sin(toRadians(values.C))) / values.c));
            ...
            if (IsNotNull(values.b) && IsNotNull(values.A) && IsNotNull(values.a)) {
                ...
                const deg = radToDeg(Math.asin((values.b * Math.sin(toRadians(values.A))) / values.a));
            ...
            if (IsNotNull(values.a) && IsNotNull(values.c) && IsNotNull(values.b)) {
                ...
                const deg = radToDeg(Math.acos((Math.pow(values.a, 2) + Math.pow(values.c, 2) - Math.pow(values.b, 2)) / (2 * values.a * values.c)));
        ...
        case "C":
            ...
            if (IsNotNull(values.c) && IsNotNull(values.B) && IsNotNull(values.b)) {
                ...
                const deg = radToDeg(Math.asin((values.c * Math.sin(toRadians(values.B))) / values.b));
            ...
            if (IsNotNull(values.c) && IsNotNull(values.A) && IsNotNull(values.a)) {
                ...
                const deg = radToDeg(Math.asin((values.c * Math.sin(toRadians(values.A))) / values.a));
            ...
            if (IsNotNull(values.a) && IsNotNull(values.b) && IsNotNull(values.c)) {
                ...
                const deg = radToDeg(Math.acos((Math.pow(values.a, 2) + Math.pow(values.b, 2) - Math.pow(values.c, 2)) / (2 * values.a * values.b)));
        ...
        if (values.hasOwnProperty(key)) {
            ...
            if (!IsNotNull(value)) {
                ...
                if(calculatedValue !== null) {
                    values[key] = Number(calculatedValue.value);
