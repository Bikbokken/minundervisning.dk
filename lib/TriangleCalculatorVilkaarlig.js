    ...
    switch (key) {
        ...
        case "A":
            ...
            if (IsNotNull(values.a) && IsNotNull(values.C) && IsNotNull(values.c)) {
                ...
                const deg = Math.asin(toRadians((values.a * Math.sin(toRadians(values.C))) / values.c));
            ...
            if (IsNotNull(values.a) && IsNotNull(values.B) && IsNotNull(values.b)) {
                ...
                const deg = Math.asin(toRadians((values.a * Math.sin(toRadians(values.B))) / values.b));
            ...
            if (IsNotNull(values.b) && IsNotNull(values.c) && IsNotNull(values.a)) {
                ...
                const deg = Math.acos(toRadians((Math.pow(values.b, 2) + Math.pow(values.c, 2) - Math.pow(values.a, 2)) / (2 * values.b * values.c)));
        ...
        case "B":
            ...
            if (IsNotNull(values.b) && IsNotNull(values.C) && IsNotNull(values.c)) {
                ...
                const deg = Math.asin(toRadians((values.b * Math.sin(toRadians(values.C))) / values.c));
            ...
            if (IsNotNull(values.b) && IsNotNull(values.A) && IsNotNull(values.a)) {
                ...
                const deg = Math.asin(toRadians((values.b * Math.sin(toRadians(values.A))) / values.a));
            ...
            if (IsNotNull(values.a) && IsNotNull(values.c) && IsNotNull(values.b)) {
                ...
                const deg = Math.acos(toRadians((Math.pow(values.a, 2) + Math.pow(values.c, 2) - Math.pow(values.b, 2)) / (2 * values.a * values.c)));
        ...
        case "C":
            ...
            if (IsNotNull(values.c) && IsNotNull(values.B) && IsNotNull(values.b)) {
                ...
                const deg = Math.asin(toRadians((values.c * Math.sin(toRadians(values.B))) / values.b));
            ...
            if (IsNotNull(values.c) && IsNotNull(values.A) && IsNotNull(values.a)) {
                ...
                const deg = Math.asin(toRadians((values.c * Math.sin(toRadians(values.A))) / values.a));
            ...
            if (IsNotNull(values.a) && IsNotNull(values.b) && IsNotNull(values.c)) {
                ...
                const deg = Math.acos(toRadians((Math.pow(values.a, 2) + Math.pow(values.b, 2) - Math.pow(values.c, 2)) / (2 * values.a * values.b)));
